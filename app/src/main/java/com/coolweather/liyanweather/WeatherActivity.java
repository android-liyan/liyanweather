...
import com.coolweather.liyanweather.gson.Forecast;
import com.coolweather.liyanweather.gson.Weather;
import com.coolweather.liyanweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String weatherIid = pref.getString("weather_id", null);  //存的
        String weatherId = getIntent().getStringExtra("weather_id");    //新选择的
        if (weatherString != null && weatherIid == weatherId) {
            //有缓存时直接解析天气数据
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendOkHttpResquest(address, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                String responseImg = response.body().string();
                SharedPreferences.Editor editor = PreferenceManager
                        .getDefaultSharedPreferences(WeatherActivity.this).edit();
                editor.putString("bing_pic", responseImg);
                editor.apply();
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.with(WeatherActivity.this).load(responseImg).into(bingPicImg);
                    }
                });
            }
        });
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        swipeRefresh.setRefreshing(false);   //取消下拉刷新框
                    }
                });
